...
public class AAFTScreen extends AbstractContainerScreen<AAFTMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(MOD_ID, "textures/gui/main_gui.png");

    public AAFTScreen(AAFTMenu menu, Inventory playerInventory, Component title) {
